...
class Datapipeline:
    ...
    def load_generator(self):
        ...
        """
        self.df_train, self.df_test = train_test_split(self.df, test_size=0.2, stratify=self.df['labels'], random_state=18)
        ...
        self.val_image_generator = tf.keras.preprocessing.image.ImageDataGenerator(validation_split=0.25)
